...
var Spawn = function Spawn(initialState, interceptors) {
  ...
  this.detect = function (zone, cb) {
    ...
    if ((0, _methods.findZoneValue)(zone, state)) {
      ...
      (0, _methods.applyLogic)({ zone: zone, subscribers: subscribers, state: state, prevState: prevState, afterUpdate: false });
    }
      ...
      return function () {
        return function (action) {
          ...
          if ((0, _methods.plainZoneValue)(zone, state) !== (0, _methods.plainZoneValue)(zone, virtualState)) {
            ...
            (0, _methods.applyLogic)({ zone: zone, subscribers: subscribers, state: state, prevState: prevState, afterUpdate: true });
