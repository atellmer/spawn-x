...
exports.applyLogic = exports.applyInterceptors = exports.compose = exports.autorun = exports.findZoneValue = exports.removeCallback = exports.checkCallback = exports.mapSubscribers = exports.clone = exports.getImmutableCopy = undefined;
...
function mapSubscribers(subscribers, subscribersArgs) {
  subscribers.forEach(function (cb, index) {
    return cb.apply(undefined, _toConsumableArray(subscribersArgs[index]));
  });
}
...
function autorun(subscribers, subscribersArgs) {
  Object.keys(subscribers).forEach(function (key) {
    return mapSubscribers(subscribers[key], subscribersArgs[key]);
  });
}
...
var Spawn = function Spawn(initialState, interceptors) {
  ...
  this.select = function (selector) {
    ...
    if ((0, _helpers.isFunc)(selector)) return (0, _methods.getImmutableCopy)(selector((0, _methods.clone)(state)));
  ...
  this.detect = function (zone, cb) {
    ...
    if (zone === '*' && (0, _methods.checkCallback)(subscribers[zone], cb)) {
      ...
      (0, _methods.mapSubscribers)(subscribers[zone], subscribersArgs[zone]);
  ...
  this.reject = function (zone, cb) {
    ...
    if (subscribers[zone]) (0, _methods.removeCallback)(subscribers[zone], cb);
    ...
    function update() {
      ...
      return function () {
        return function (action) {
          ...
          state = (0, _methods.clone)(newState);
