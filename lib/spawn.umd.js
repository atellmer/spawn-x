...
function createStore() {
  ...
  if (args.length === 1) {
    if ((0, _helpers.isPlainObject)(args[0])) {
      ...
      return (0, _helpers.error)('Spawn: createStore with one argument takes only a plain object or addInterceptor function!');
    }
  }
  if (args.length > 1) {
    if ((0, _helpers.isPlainObject)(args[0])) {
    ...
    return (0, _helpers.error)('Spawn: createStore with two arguments takes as second argument only addInterceptor function!');
  }
...
var Spawn = function Spawn(initialState, interceptors) {
  ...
  this.update = function (zone, action) {
    ...
    if (!(0, _helpers.hasKey)(action, 'data')) return (0, _helpers.error)('Spawn: action must have a \'data\' key!');
    if (!(0, _helpers.hasKey)(action, 'type')) return (0, _helpers.error)('Spawn: action must have a \'type\' key!');
    if (!(0, _helpers.isString)(action.type)) return (0, _helpers.error)('Spawn: type of action must be a string!');
